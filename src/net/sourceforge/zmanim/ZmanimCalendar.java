...
protected ShaahZmanis shaahZmanisType = ShaahZmanis.GRA;
	 ...
	 *            this method.
	 * @return the date of the latest <em>zman shema</em> based on the start and end of day times passed to this
	 ...
	 * "https://en.wikipedia.org/wiki/Maimonides">Rambam</a></em> and
	  <em>Rabbeinu Tam</em> that <em>tzais</em> is* calculated as 72 minutes, the time it takes to walk 4 <em>Mil</em> at
	  18 minutes a <em>Mil</em>. Based on
	 * the on the {@link #isUseElevation()} setting) a 72 minute offset from either {@link #getSunset() sunset} or
	 * {@link #getSeaLevelSunset() sea levelsunset} is used.
	 *
	 * @see ComplexZmanimCalendar#getTzais16Point1Degrees()
	 ...
	 *            method.
	 * @return the date of the latest <em>zman tfilah</em> based on the start and end of day times passed
